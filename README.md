...
Download **companion-module-telos-25-seven-program-delay-manager-v1.1.1.tgz** from the Assets section of this release and import it into Bitfocus Companion using the *Import module package* button in the modules section on the left pane.
